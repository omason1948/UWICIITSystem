...
class LTAutomate(unittest.TestCase):
    ...
    def test_register(self):
        ...
        register = driver.find_element_by_css_selector("a[href='/events/register/5ee1413545bdb958043e53e8']")
        register.click()

        
        findtext = driver.find_elements_by_xpath("//h4[contains(text(), 'Painting Class')]")
